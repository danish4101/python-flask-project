...
# Update the user and password values for the PostgreSQL connection
db = PostgresqlDatabase('flask_lab', user='peewee', password='12345', host='localhost', port=5432)
...
Person(name='Danish', age=21).save()
Person(name='Bhatti', age=22).save()
Person(name='Dawood', age=23).save()
Person(name='Mansoor', age=38).save()

Pet(name='Puppy', animal_type='dog', owner_id=1).save()
Pet(name='PUPPYYY', animal_type='dog', owner_id=2).save()
